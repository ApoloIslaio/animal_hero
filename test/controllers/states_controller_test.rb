...
class StatesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create state" do
    assert_difference('State.count') do
      post states_url, params: { state: { description: @state.description, initials: @state.initials } }
    end
  ...
  test "should update state" do
    patch state_url(@state), params: { state: { description: @state.description, initials: @state.initials } }
