...
class ClinicsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create clinic" do
    assert_difference('Clinic.count') do
      post clinics_url, params: { clinic: { description: @clinic.description, email: @clinic.email, logo: @clinic.logo } }
    end
  ...
  test "should update clinic" do
    patch clinic_url(@clinic), params: { clinic: { description: @clinic.description, email: @clinic.email, logo: @clinic.logo } }
